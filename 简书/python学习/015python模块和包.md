...
```python
import random
print(random.__file__)    #打印这个包的所在文件路径
# 生成一个 0～10 的数字
...
### 案例详情:
> 目录:
![image.png](https://upload-images.jianshu.io/upload_images/14555448-5444796ed9745bbf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
__init__文件:
```python
from . import send_message # 从当前目录下导入哪些模块
from . import receive_message
...
hm_message.send_message.send("hello")#包名.模块名.函数名
